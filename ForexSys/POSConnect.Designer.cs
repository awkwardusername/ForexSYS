namespace ForexSys {
	partial class POSConnect {
		...
		private void InitializeComponent() {
			...
			// IPServer
			// 
			this.IPServer.Location = new System.Drawing.Point(72, 10);
			this.IPServer.Name = "IPServer";
			this.IPServer.Size = new System.Drawing.Size(203, 20);
			...
			this.ClientSize = new System.Drawing.Size(329, 38);
			this.Controls.Add(this.button1);
			this.Controls.Add(this.IPServer);
			this.Controls.Add(this.label1);
			this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedToolWindow;
			this.Name = "POSConnect";
